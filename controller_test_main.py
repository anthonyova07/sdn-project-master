...
class DynamicController(ControllerBase):
 ...
 #url1 = http:<ip-aadr>:<tcp_port>/dynamicaccess/requestconfig'
    #
    #
    @route(app_name, url1, methods=['POST'])
    def requestconfig(self, req, **kwargs):
        ...
        #     simple_switch.json_request_parse(new_entry)
